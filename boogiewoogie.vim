...
hi MatchParen   ctermfg=203 ctermbg=NONE cterm=bold guifg=#D71F07 guibg=NONE gui=bold
...
hi Directory    ctermfg=177 ctermbg=NONE cterm=NONE guifg=#131313 guibg=NONE gui=NONE
hi Folded       ctermfg=68 ctermbg=23 cterm=NONE guifg=#005BBB guibg=#131313 gui=NONE
...
hi DiffAdd      ctermfg=231 ctermbg=64 cterm=bold guifg=#EDEDED guibg=#53C22B gui=bold
...
" markdown
hi mkdHeading ctermfg=NONE ctermbg=NONE cterm=NONE guifg=#131313 guibg=NONE gui=bold
hi mkdItalic ctermfg=NONE ctermbg=NONE cterm=italic guifg=#131313 guibg=NONE gui=italic
